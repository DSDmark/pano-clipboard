...
class ClipboardApp extends Adw.Application {
    ...
    constructor() {
        ...
        // Set up tray icon
        this.indicator = AppIndicator.Indicator.new("clipboard-manager", "edit-paste-symbolic", AppIndicator.IndicatorCategory.APPLICATION_STATUS);
        ...
        this.dbusProxy = Gio.DBusProxy.new_sync(Gio.DBus.session, Gio.DBusProxyFlags.NONE, null, "org.yourdomain.ClipboardDaemon", "/org/yourdomain/ClipboardDaemon", "org.yourdomain.ClipboardDaemon", null);
        // Listen for updates
        this.dbusProxy.connect_signal("HistoryUpdated", this.loadHistory.bind(this));
        // Initial load
        this.loadHistory();
    }
}
