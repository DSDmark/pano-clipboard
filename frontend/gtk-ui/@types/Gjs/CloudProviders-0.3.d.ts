...
export class DbusAccount {
    ...
    /* Methods of CloudProviders.DbusAccount */
    /* Virtual methods of CloudProviders.DbusAccount */
    static name: string
...
export class DbusProvider {
    ...
    name: string
    /* Methods of CloudProviders.DbusProvider */
    /* Virtual methods of CloudProviders.DbusProvider */
    static name: string
    static interface_info(): Gio.DBusInterfaceInfo
    static override_properties(klass: GObject.ObjectClass, property_id_begin: number): number
}
...
export class DbusAccountProxy {
    ...
    status: number
    status_details: string
    /* Fields of CloudProviders.DbusAccountProxy */
...
export class DbusAccountSkeleton {
    ...
    status: number
    status_details: string
    /* Fields of CloudProviders.DbusAccountSkeleton */
    ...
    get_vtable(): Gio.DBusInterfaceVTable
    ...
    vfunc_get_vtable?(): Gio.DBusInterfaceVTable
    /* Virtual methods of GObject.Object */
    vfunc_constructed?(): void
    vfunc_dispatch_properties_changed?(n_pspecs: number, pspecs: GObject.ParamSpec): void
    vfunc_dispose?(): void
...
export class DbusObjectManagerClient {
    ...
    /* Fields of CloudProviders.DbusObjectManagerClient */
...
export class DbusObjectProxy {
    ...
    account: DbusAccount
    provider: DbusProvider
    /* Fields of CloudProviders.DbusObjectProxy */
...
export class DbusObjectSkeleton {
    ...
    account: DbusAccount
    provider: DbusProvider
    /* Fields of CloudProviders.DbusObjectSkeleton */
...
export class DbusProviderProxy {
    ...
    /* Properties of CloudProviders.DbusProvider */
    name: string
    /* Fields of CloudProviders.DbusProviderProxy */
    /* Fields of Gio.DBusProxy */
    /* Fields of GObject.Object */
    g_type_instance: GObject.TypeInstance
    /* Methods of Gio.DBusProxy */
...
export class DbusProviderSkeleton {
    ...
    /* Properties of CloudProviders.DbusProvider */
    name: string
    /* Fields of CloudProviders.DbusProviderSkeleton */
    /* Fields of Gio.DBusInterfaceSkeleton */
    /* Fields of GObject.Object */
    g_type_instance: GObject.TypeInstance
    /* Methods of Gio.DBusInterfaceSkeleton */
