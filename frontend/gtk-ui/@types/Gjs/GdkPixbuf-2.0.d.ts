...
export class Pixbuf {
    ...
    save_to_bufferv(type: string, option_keys?: string[] | null, option_values?: string[] | null): [ /* returnType */ boolean, /* buffer */ Gjs.byteArray.ByteArray ]
    ...
    static new_from_file_at_scale(filename: string, width: number, height: number, preserve_aspect_ratio: boolean): Pixbuf | null
    static new_from_file_at_size(filename: string, width: number, height: number): Pixbuf | null
    ...
    static new_from_resource_at_scale(resource_path: string, width: number, height: number, preserve_aspect_ratio: boolean): Pixbuf | null
    static new_from_stream(stream: Gio.InputStream, cancellable?: Gio.Cancellable | null): Pixbuf | null
    static new_from_stream_at_scale(stream: Gio.InputStream, width: number, height: number, preserve_aspect_ratio: boolean, cancellable?: Gio.Cancellable | null): Pixbuf | null
    static new_from_stream_finish(async_result: Gio.AsyncResult): Pixbuf | null
    static new_from_xpm_data(data: string[]): Pixbuf | null
...
export class PixbufAnimation {
    ...
    static new_from_stream(stream: Gio.InputStream, cancellable?: Gio.Cancellable | null): PixbufAnimation | null
    static new_from_stream_finish(async_result: Gio.AsyncResult): PixbufAnimation | null
    static new_from_stream_async(stream: Gio.InputStream, cancellable?: Gio.Cancellable | null, callback?: Gio.AsyncReadyCallback | null): void
    static $gtype: GObject.Type
}
