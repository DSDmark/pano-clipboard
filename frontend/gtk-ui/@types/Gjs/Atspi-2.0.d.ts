...
export function generate_mouse_event_async(x: number, y: number, name: string, callback: GenerateMouseEventCB): void
...
export abstract class DeviceClass {
    ...
    grab_keyboard: any
    ungrab_keyboard: any
    get_locked_modifiers: any
    generate_mouse_event: any
    map_keysym_modifier: any
    unmap_keysym_modifier: any
    get_keysym_modifier: any
    static name: string
}
