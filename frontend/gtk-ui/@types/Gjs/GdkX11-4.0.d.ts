...
export class X11Display {
    ...
    string_to_compound_text(str: string): [ /* returnType */ number, /* encoding */ string, /* format */ number, /* ctext */ Gjs.byteArray.ByteArray ]
    text_property_to_text_list(encoding: string, format: number, text: number, length: number, list: string): number
    ungrab(): void
    utf8_to_compound_text(str: string): [ /* returnType */ boolean, /* encoding */ string, /* format */ number, /* ctext */ Gjs.byteArray.ByteArray ]
