...
export function color_state_get_oklab(): ColorState
export function color_state_get_oklch(): ColorState
export function color_state_get_rec2100_linear(): ColorState
export function color_state_get_rec2100_pq(): ColorState
export function color_state_get_srgb(): ColorState
export function color_state_get_srgb_linear(): ColorState
...
export function dmabuf_error_quark(): GLib.Quark
...
export interface CursorGetTextureCallback {
    (cursor: Cursor, cursor_size: number, scale: number, data?: object | null): Texture | null
}
...
export class AppLaunchContext {
    ...
    get_startup_notify_id(info?: Gio.AppInfo | null, files?: Gio.File[] | null): string | null
    ...
    vfunc_get_startup_notify_id?(info?: Gio.AppInfo | null, files?: Gio.File[] | null): string | null
...
export class ContentProvider {
    ...
    static new_for_bytes(mime_type: string, bytes: Gjs.byteArray.ByteArray): ContentProvider
...
export class Cursor {
    ...
    static new_from_callback(callback: CursorGetTextureCallback, fallback?: Cursor | null): Cursor | null
...
export class GLTextureBuilder {
    ...
    set_sync(sync?: object | null): void
    set_update_region(region?: cairo.Region | null): void
    set_update_texture(texture?: Texture | null): void
    set_width(width: number): void
    /* Methods of GObject.Object */
...
export class MemoryTexture {
    ...
    static new(width: number, height: number, format: MemoryFormat, bytes: Gjs.byteArray.ByteArray, stride: number): MemoryTexture
    static $gtype: GObject.Type
}
...
export class MemoryTextureBuilder {
    ...
    get_update_texture(): Texture | null
    get_width(): number
    set_bytes(bytes?: Gjs.byteArray.ByteArray): void
    set_color_state(color_state: ColorState): void
    set_format(format: MemoryFormat): void
    set_height(height: number): void
    set_offset(plane: number, offset: number): void
...
export class DmabufFormats {
    ...
    get_format(idx: number): [ /* fourcc */ number, /* modifier */ number ]
...
export class TextureDownloader {
    ...
    download_bytes(): [ /* returnType */ Gjs.byteArray.ByteArray, /* out_stride */ number ]
    download_bytes_with_planes(): [ /* returnType */ Gjs.byteArray.ByteArray, /* out_offsets */ number[], /* out_strides */ number[] ]
    download_into(data: Gjs.byteArray.ByteArray, stride: number): void
    free(): void
    get_color_state(): ColorState
    get_format(): MemoryFormat
    get_texture(): Texture
