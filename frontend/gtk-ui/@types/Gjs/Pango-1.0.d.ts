...
export function attr_break(text: string, length: number, attr_list: AttrList, offset: number): /* attrs */ LogAttr[]
...
export function default_break(text: string, length: number, analysis: Analysis | null): /* attrs */ LogAttr[]
...
export function find_paragraph_boundary(text: string, length: number): [ /* paragraph_delimiter_index */ number | null, /* next_paragraph_start */ number | null ]
export function font_description_from_string(str: string): FontDescription
export function get_log_attrs(text: string, length: number, level: number, language: Language): /* attrs */ LogAttr[]
export function get_mirror_char(ch: number): [ /* returnType */ boolean, /* mirrored_ch */ number | null ]
...
export function log2vis_get_embedding_levels(text: string, length: number, pbase_dir: Direction): Gjs.byteArray.ByteArray
...
export function shape_full(item_text: string, item_length: number, paragraph_text: string | null, paragraph_length: number, analysis: Analysis): /* glyphs */ GlyphString
export function shape_item(item: Item, paragraph_text: string | null, paragraph_length: number, log_attrs: LogAttr | null, flags: ShapeFlags): /* glyphs */ GlyphString
export function shape_with_flags(item_text: string, item_length: number, paragraph_text: string | null, paragraph_length: number, analysis: Analysis, flags: ShapeFlags): /* glyphs */ GlyphString
...
export function tailor_break(text: string, length: number, analysis: Analysis, offset: number): /* attrs */ LogAttr[]
...
export class Font {
    ...
    vfunc_get_features?(num_features: number): /* features */ HarfBuzz.feature_t[]
    ...
    static deserialize(context: Context, bytes: Gjs.byteArray.ByteArray): Font | null
    static $gtype: GObject.Type
}
...
export class Layout {
    ...
    static deserialize(context: Context, bytes: Gjs.byteArray.ByteArray, flags: LayoutDeserializeFlags): Layout | null
    static $gtype: GObject.Type
}
...
export class GlyphItem {
    ...
    copy(): GlyphItem | null
    free(): void
    get_logical_widths(text: string): /* logical_widths */ number[]
...
export class GlyphString {
    ...
    get_width(): number
    index_to_x(text: string, length: number, analysis: Analysis, index_: number, trailing: boolean): /* x_pos */ number | null
    index_to_x_full(text: string, length: number, analysis: Analysis, attrs: LogAttr | null, index_: number, trailing: boolean): /* x_pos */ number | null
    set_size(new_len: number): void
    x_to_index(text: string, length: number, analysis: Analysis, x_pos: number): [ /* index_ */ number | null, /* trailing */ number | null ]
    static name: string
