...
export function boxedTypeRegisterStatic(name: string, boxedCopy: BoxedCopyFunc, boxedFree: BoxedFreeFunc): Type
...
export function paramSpecBoxed(name: string, nick: string | null, blurb: string | null, boxedType: Type, flags: ParamFlags): ParamSpec
...
export function paramSpecEnum(name: string, nick: string | null, blurb: string | null, enumType: Type, defaultValue: number, flags: ParamFlags): ParamSpec
export function paramSpecFlags(name: string, nick: string | null, blurb: string | null, flagsType: Type, defaultValue: number, flags: ParamFlags): ParamSpec
...
export function paramSpecGtype(name: string, nick: string | null, blurb: string | null, isAType: Type, flags: ParamFlags): ParamSpec
...
export function paramSpecObject(name: string, nick: string | null, blurb: string | null, objectType: Type, flags: ParamFlags): ParamSpec
export function paramSpecParam(name: string, nick: string | null, blurb: string | null, paramType: Type, flags: ParamFlags): ParamSpec
...
export function paramSpecUnichar(name: string, nick: string | null, blurb: string | null, defaultValue: number, flags: ParamFlags): ParamSpec
...
export function paramValueIsValid(pspec: ParamSpec, value: Value): boolean
...
export function signalOverrideClassHandler(signalName: string, instanceType: Type, classHandler: Callback): void
...
export function typeClassGet(type: Type): TypeClass
export function typeClassPeek(type: Type): TypeClass | null
export function typeClassPeekStatic(type: Type): TypeClass | null
export function typeClassRef(type: Type): TypeClass
export function typeDefaultInterfaceGet(gType: Type): TypeInterface
...
export function typeInterfacePeek(instanceClass: TypeClass, ifaceType: Type): TypeInterface | null
...
export function typeName(type: Type): string | null
...
export function variantGetGtype(): Type
...
export interface TypeValueCollectFunc {
    (value: Value, collectValues: TypeCValue[], collectFlags: number): string | null
}
...
export class BindingGroup {
    ...
    bindFull(sourceProperty: string, target: Object, targetProperty: string, flags: BindingFlags, transformTo?: Closure | null, transformFrom?: Closure | null): void
    dupSource(): Object | null
...
export class ParamSpec {
    ...
    vfuncFinalize?(): void
    vfuncValueIsValid?(value: Value): boolean
...
export class SignalGroup {
    ...
    block(): void
    connectClosure(detailedSignal: string, closure: Closure, after: boolean): void
...
export abstract class ObjectClass {
    ...
    findProperty(propertyName: string): ParamSpec
    installProperties(pspecs: ParamSpec[]): void
    installProperty(propertyId: number, pspec: ParamSpec): void
    listProperties(): ParamSpec[]
...
export class TypeClass {
    ...
    static get(type: Type): TypeClass
    static peek(type: Type): TypeClass | null
    static peekStatic(type: Type): TypeClass | null
...
export class TypeInterface {
    ...
    static peek(instanceClass: TypeClass, ifaceType: Type): TypeInterface | null
