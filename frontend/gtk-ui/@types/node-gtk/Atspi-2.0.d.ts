...
export const DBUS_INTERFACE_KEYBOARD_MONITOR: string
...
export const DBUS_NAME_A11Y_MANAGER: string
export const DBUS_NAME_REGISTRY: string
export const DBUS_PATH_A11Y_MANAGER: string
...
export const DEVICE_A11Y_MANAGER_VIRTUAL_MOD_END: number
export const DEVICE_A11Y_MANAGER_VIRTUAL_MOD_START: number
...
export function generateMouseEventAsync(x: number, y: number, name: string, callback: GenerateMouseEventCB): void
...
export class Device {
    ...
    addKeyWatcher(callback: KeyCallback): void
    clearKeyGrabs(): void
    generateMouseEvent(obj: Accessible, x: number, y: number, name: string): void
    getAppId(): string
    getGrabById(id: number): KeyDefinition
    getKeysymModifier(keysym: number): number
    getLockedModifiers(): number
    getModifier(keycode: number): number
    grabKeyboard(): boolean
    mapKeysymModifier(keysym: number): number
    ...
    ungrabKeyboard(): void
    unmapKeysymModifier(keysym: number): void
    ...
    vfuncAddKeyGrab?(kd: KeyDefinition): boolean
    vfuncGenerateMouseEvent?(obj: Accessible, x: number, y: number, name: string): void
    vfuncGetKeysymModifier?(keysym: number): number
    vfuncGetLockedModifiers?(): number
    vfuncGetModifier?(keycode: number): number
    vfuncGrabKeyboard?(): boolean
    vfuncMapKeysymModifier?(keysym: number): number
    vfuncMapModifier?(keycode: number): number
    vfuncRemoveKeyGrab?(id: number): void
    vfuncUngrabKeyboard?(): void
    vfuncUnmapKeysymModifier?(keysym: number): void
    ...
    static new(): Device
    static newFull(appId?: string | null): Device
    static $gtype: GObject.Type
}
export interface DeviceA11yManager_ConstructProps extends Device_ConstructProps {
}
export class DeviceA11yManager {
    /* Properties of Atspi.DeviceA11yManager */
    /* Properties of Atspi.Device */
    /* Fields of Atspi.Device */
    parentInstance: GObject.Object
    /* Fields of GObject.Object */
    ...
    vfuncSetProperty?(propertyId: number, value: GObject.Value, pspec: GObject.ParamSpec): void
    /* Signals of GObject.Object */
    connect(sigName: "notify", callback: (($obj: DeviceA11yManager, pspec: GObject.ParamSpec) => void)): number
    connect_after(sigName: "notify", callback: (($obj: DeviceA11yManager, pspec: GObject.ParamSpec) => void)): number
    emit(sigName: "notify", pspec: GObject.ParamSpec): void
    on(sigName: "notify", callback: (...args: any[]) => void): NodeJS.EventEmitter
    once(sigName: "notify", callback: (...args: any[]) => void): NodeJS.EventEmitter
    off(sigName: "notify", callback: (...args: any[]) => void): NodeJS.EventEmitter
    ...
    off(sigName: string, callback: any): NodeJS.EventEmitter
    static name: string
    constructor (config?: DeviceA11yManager_ConstructProps)
    _init (config?: DeviceA11yManager_ConstructProps): void
    static tryNew(): DeviceA11yManager
    static tryNewFull(appId?: string | null): DeviceA11yManager
    static $gtype: GObject.Type
}
...
export class DeviceLegacy {
    ...
    static newFull(appId?: string | null): DeviceLegacy
    static $gtype: GObject.Type
}
...
export class DeviceX11 {
    ...
    static newFull(appId?: string | null): DeviceX11
    static $gtype: GObject.Type
}
...
export class EventListener {
    ...
    static registerFromCallbackFull(callback: EventListenerCB, eventType: string, properties: string[]): boolean
    static registerFromCallbackWithApp(callback: EventListenerCB, eventType: string, properties: string[], app?: Accessible | null): boolean
    static $gtype: GObject.Type
}
...
export class MatchRule {
    ...
    static new(states: StateSet | null, statematchtype: CollectionMatchType, attributes: GLib.HashTable | null, attributematchtype: CollectionMatchType, roles: Role[] | null, rolematchtype: CollectionMatchType, interfaces: string[] | null, interfacematchtype: CollectionMatchType, invert: boolean): MatchRule
    static $gtype: GObject.Type
}
...
export abstract class DeviceA11yManagerClass {
    /* Fields of Atspi.DeviceA11yManagerClass */
...
export abstract class DeviceClass {
    ...
    grabKeyboard: any
    ungrabKeyboard: any
    getLockedModifiers: any
    generateMouseEvent: any
    mapKeysymModifier: any
    unmapKeysymModifier: any
    getKeysymModifier: any
    static name: string
}
...
export class TextSelection {
    /* Fields of Atspi.TextSelection */
    startObject: Accessible
    startOffset: number
    endObject: Accessible
    endOffset: number
