...
export interface PixbufModuleIncrementLoadFunc {
    (context: object | null, buf: any): boolean
}
...
export interface PixbufModuleSaveFunc {
    (f: object | null, pixbuf: Pixbuf, paramKeys?: string[] | null, paramValues?: string[] | null): boolean
}
...
export class Pixbuf {
    ...
    addAlpha(substituteColor: boolean, r: number, g: number, b: number): Pixbuf | null
    ...
    static new(colorspace: Colorspace, hasAlpha: boolean, bitsPerSample: number, width: number, height: number): Pixbuf | null
    ...
    static newFromFile(filename: string): Pixbuf | null
    static newFromFileAtScale(filename: string, width: number, height: number, preserveAspectRatio: boolean): Pixbuf | null
    static newFromFileAtSize(filename: string, width: number, height: number): Pixbuf | null
    static newFromInline(data: any, copyPixels: boolean): Pixbuf
    static newFromResource(resourcePath: string): Pixbuf | null
    static newFromResourceAtScale(resourcePath: string, width: number, height: number, preserveAspectRatio: boolean): Pixbuf | null
    static newFromStream(stream: Gio.InputStream, cancellable?: Gio.Cancellable | null): Pixbuf | null
    static newFromStreamAtScale(stream: Gio.InputStream, width: number, height: number, preserveAspectRatio: boolean, cancellable?: Gio.Cancellable | null): Pixbuf | null
    static newFromStreamFinish(asyncResult: Gio.AsyncResult): Pixbuf | null
    static newFromXpmData(data: string[]): Pixbuf | null
...
export class PixbufAnimation {
    ...
    static newFromFile(filename: string): PixbufAnimation | null
    static newFromResource(resourcePath: string): PixbufAnimation | null
    static newFromStream(stream: Gio.InputStream, cancellable?: Gio.Cancellable | null): PixbufAnimation | null
    static newFromStreamFinish(asyncResult: Gio.AsyncResult): PixbufAnimation | null
    static newFromStreamAsync(stream: Gio.InputStream, cancellable?: Gio.Cancellable | null, callback?: Gio.AsyncReadyCallback | null): void
    static $gtype: GObject.Type
}
