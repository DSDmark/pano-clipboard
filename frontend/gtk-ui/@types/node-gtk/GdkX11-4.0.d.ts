...
export class X11AppLaunchContext {
    ...
    connect_after(sigName: "launch-started", callback: (($obj: X11AppLaunchContext, info: Gio.AppInfo, platformData?: GLib.Variant | null) => void)): number
...
export class X11DeviceManagerXI2 {
    /* Properties of GdkX11.X11DeviceManagerXI2 */
    /* Fields of GObject.Object */
    gTypeInstance: GObject.TypeInstance
    /* Methods of GObject.Object */
    bindProperty(sourceProperty: string, target: GObject.Object, targetProperty: string, flags: GObject.BindingFlags): GObject.Binding
...
export class X11DeviceXI2 {
    /* Properties of GdkX11.X11DeviceXI2 */
    ...
    once(sigName: "notify", callback: (...args: any[]) => void): NodeJS.EventEmitter
    off(sigName: "notify", callback: (...args: any[]) => void): NodeJS.EventEmitter
    connect(sigName: "notify::active-layout-index", callback: (($obj: X11DeviceXI2, pspec: GObject.ParamSpec) => void)): number
    connect_after(sigName: "notify::active-layout-index", callback: (($obj: X11DeviceXI2, pspec: GObject.ParamSpec) => void)): number
    ...
    connect(sigName: "notify::layout-names", callback: (($obj: X11DeviceXI2, pspec: GObject.ParamSpec) => void)): number
    connect_after(sigName: "notify::layout-names", callback: (($obj: X11DeviceXI2, pspec: GObject.ParamSpec) => void)): number
...
export class X11Display {
    ...
    readonly dmabufFormats: Gdk.DmabufFormats
    ...
    connect(sigName: "notify::dmabuf-formats", callback: (($obj: X11Display, pspec: GObject.ParamSpec) => void)): number
    connect_after(sigName: "notify::dmabuf-formats", callback: (($obj: X11Display, pspec: GObject.ParamSpec) => void)): number
    ...
    connect(sigName: "notify::shadow-width", callback: (($obj: X11Display, pspec: GObject.ParamSpec) => void)): number
    connect_after(sigName: "notify::shadow-width", callback: (($obj: X11Display, pspec: GObject.ParamSpec) => void)): number
...
export class X11Monitor {
    ...
    connect(sigName: "notify::scale", callback: (($obj: X11Monitor, pspec: GObject.ParamSpec) => void)): number
    connect_after(sigName: "notify::scale", callback: (($obj: X11Monitor, pspec: GObject.ParamSpec) => void)): number
