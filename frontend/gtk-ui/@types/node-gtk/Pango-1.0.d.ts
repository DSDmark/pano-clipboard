...
export function attrBreak(text: string, length: number, attrList: AttrList, offset: number): /* attrs */ LogAttr[]
...
export function break_TODO(text: string, length: number, analysis: Analysis): /* attrs */ LogAttr[]
export function defaultBreak(text: string, length: number, analysis: Analysis | null): /* attrs */ LogAttr[]
export function extentsToPixels(inclusive: Rectangle, nearest: Rectangle): void
export function findBaseDir(text: string, length: number): Direction
export function findParagraphBoundary(text: string, length: number): [ /* paragraphDelimiterIndex */ number | null, /* nextParagraphStart */ number | null ]
export function fontDescriptionFromString(str: string): FontDescription
export function getLogAttrs(text: string, length: number, level: number, language: Language): /* attrs */ LogAttr[]
export function getMirrorChar(ch: number): [ /* returnType */ boolean, /* mirroredCh */ number | null ]
...
export function log2visGetEmbeddingLevels(text: string, length: number, pbaseDir: Direction): any
...
export function scanString(pos: string, out: GLib.String): boolean
export function scanWord(pos: string, out: GLib.String): boolean
export function scriptForUnichar(ch: number): Script
export function scriptGetSampleLanguage(script: Script): Language | null
export function shape(text: string, length: number, analysis: Analysis): /* glyphs */ GlyphString
export function shapeFull(itemText: string, itemLength: number, paragraphText: string | null, paragraphLength: number, analysis: Analysis): /* glyphs */ GlyphString
export function shapeItem(item: Item, paragraphText: string | null, paragraphLength: number, logAttrs: LogAttr | null, flags: ShapeFlags): /* glyphs */ GlyphString
export function shapeWithFlags(itemText: string, itemLength: number, paragraphText: string | null, paragraphLength: number, analysis: Analysis, flags: ShapeFlags): /* glyphs */ GlyphString
...
export function tailorBreak(text: string, length: number, analysis: Analysis, offset: number): /* attrs */ LogAttr[]
...
export class Font {
    ...
    getFace(): FontFace | null
    getFeatures(numFeatures: number): /* features */ HarfBuzz.feature_t[]
    getFontMap(): FontMap | null
    ...
    vfuncGetFeatures?(numFeatures: number): /* features */ HarfBuzz.feature_t[]
...
export class FontFamily {
    ...
    readonly itemType: GObject.Type
    ...
    connect(sigName: "items-changed", callback: (($obj: FontFamily, position: number, removed: number, added: number) => void)): number
    connect_after(sigName: "items-changed", callback: (($obj: FontFamily, position: number, removed: number, added: number) => void)): number
    ...
    connect(sigName: "notify::is-monospace", callback: (($obj: FontFamily, pspec: GObject.ParamSpec) => void)): number
    connect_after(sigName: "notify::is-monospace", callback: (($obj: FontFamily, pspec: GObject.ParamSpec) => void)): number
    on(sigName: "notify::is-monospace", callback: (...args: any[]) => void): NodeJS.EventEmitter
    once(sigName: "notify::is-monospace", callback: (...args: any[]) => void): NodeJS.EventEmitter
    off(sigName: "notify::is-monospace", callback: (...args: any[]) => void): NodeJS.EventEmitter
    connect(sigName: "notify::is-variable", callback: (($obj: FontFamily, pspec: GObject.ParamSpec) => void)): number
    connect_after(sigName: "notify::is-variable", callback: (($obj: FontFamily, pspec: GObject.ParamSpec) => void)): number
    on(sigName: "notify::is-variable", callback: (...args: any[]) => void): NodeJS.EventEmitter
    once(sigName: "notify::is-variable", callback: (...args: any[]) => void): NodeJS.EventEmitter
    off(sigName: "notify::is-variable", callback: (...args: any[]) => void): NodeJS.EventEmitter
    ...
    connect(sigName: "notify::name", callback: (($obj: FontFamily, pspec: GObject.ParamSpec) => void)): number
    connect_after(sigName: "notify::name", callback: (($obj: FontFamily, pspec: GObject.ParamSpec) => void)): number
...
export class FontMap {
    ...
    reloadFont(font: Font, scale: number, context?: Context | null, variations?: string | null): Font
    /* Methods of GObject.Object */
    bindProperty(sourceProperty: string, target: GObject.Object, targetProperty: string, flags: GObject.BindingFlags): GObject.Binding
    bindPropertyFull(sourceProperty: string, target: GObject.Object, targetProperty: string, flags: GObject.BindingFlags, transformTo: GObject.Closure, transformFrom: GObject.Closure): GObject.Binding
    forceFloating(): void
    ...
    off(sigName: "notify", callback: (...args: any[]) => void): NodeJS.EventEmitter
    /* Signals of Gio.ListModel */
    connect(sigName: "items-changed", callback: (($obj: FontMap, position: number, removed: number, added: number) => void)): number
    connect_after(sigName: "items-changed", callback: (($obj: FontMap, position: number, removed: number, added: number) => void)): number
    emit(sigName: "items-changed", position: number, removed: number, added: number): void
    on(sigName: "items-changed", callback: (...args: any[]) => void): NodeJS.EventEmitter
    once(sigName: "items-changed", callback: (...args: any[]) => void): NodeJS.EventEmitter
    off(sigName: "items-changed", callback: (...args: any[]) => void): NodeJS.EventEmitter
...
export class FontDescription {
    ...
    setFeaturesStatic(features: string): void
...
export class GlyphItem {
    ...
    copy(): GlyphItem | null
    free(): void
    getLogicalWidths(text: string): /* logicalWidths */ number[]
...
export class GlyphString {
    ...
    free(): void
    getLogicalWidths(text: string, length: number, embeddingLevel: number): /* logicalWidths */ number[]
    getWidth(): number
    indexToX(text: string, length: number, analysis: Analysis, index: number, trailing: boolean): /* xPos */ number | null
    indexToXFull(text: string, length: number, analysis: Analysis, attrs: LogAttr | null, index: number, trailing: boolean): /* xPos */ number | null
    setSize(newLen: number): void
    xToIndex(text: string, length: number, analysis: Analysis, xPos: number): [ /* index */ number | null, /* trailing */ number | null ]
    static name: string
...
export class Matrix {
    ...
    transformPixelRectangle(rect: Rectangle): void
