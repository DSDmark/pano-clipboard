...
export function alignedFreeSized(mem: object | null, alignment: number, size: number): void
...
export function assertionMessageCmpint(domain: string, file: string, line: number, func: string, expr: string, arg1: number, cmp: string, arg2: number, numtype: number): void
...
export function asyncQueueNew(): AsyncQueue
export function asyncQueueNewFull(itemFreeFunc?: DestroyNotify | null): AsyncQueue
export function atexit(func: VoidFunc): void
export function atomicIntAdd(atomic: object | null, val: number): number
export function atomicIntAnd(atomic: object | null, val: number): number
export function atomicIntCompareAndExchange(atomic: object | null, oldval: number, newval: number): boolean
export function atomicIntCompareAndExchangeFull(atomic: object | null, oldval: number, newval: number): [ /* returnType */ boolean, /* preval */ number ]
export function atomicIntDecAndTest(atomic?: object | null): boolean
export function atomicIntExchange(atomic: object | null, newval: number): number
export function atomicIntExchangeAndAdd(atomic: object | null, val: number): number
export function atomicIntGet(atomic?: object | null): number
export function atomicIntInc(atomic?: object | null): void
export function atomicIntOr(atomic: object | null, val: number): number
export function atomicIntSet(atomic: object | null, newval: number): void
export function atomicIntXor(atomic: object | null, val: number): number
export function atomicPointerAdd(atomic: object, val: number): any
export function atomicPointerAnd(atomic: object, val: number): any
export function atomicPointerCompareAndExchange(atomic: object, oldval?: object | null, newval?: object | null): boolean
export function atomicPointerCompareAndExchangeFull(atomic: object, oldval?: object | null, newval?: object | null): [ /* returnType */ boolean, /* preval */ object ]
export function atomicPointerExchange(atomic?: object | null, newval?: object | null): object | null
export function atomicPointerGet(atomic: object): object | null
export function atomicPointerOr(atomic: object, val: number): any
export function atomicPointerSet(atomic: object, newval?: object | null): void
export function atomicPointerXor(atomic: object, val: number): any
...
export function atomicRefCountInit(): /* arc */ number
...
export function bitLock(address: object | null, lockBit: number): void
export function bitLockAndGet(address: object | null, lockBit: number): /* outVal */ number | null
...
export function bitTrylock(address: object | null, lockBit: number): boolean
export function bitUnlock(address: object | null, lockBit: number): void
export function bitUnlockAndSet(address: object | null, lockBit: number, newVal: number, preserveMask: number): void
export function blowChunks(): void
...
export function byteArrayAppend(array: any, data: any): any
export function byteArrayFree(array: any, freeSegment: boolean): any | null
...
export function byteArrayPrepend(array: any, data: any): any
export function byteArrayRef(array: any): any
export function byteArrayRemoveIndex(array: any, index: number): any
export function byteArrayRemoveIndexFast(array: any, index: number): any
export function byteArrayRemoveRange(array: any, index: number, length: number): any
export function byteArraySetSize(array: any, length: number): any
export function byteArraySizedNew(reservedSize: number): any
export function byteArraySort(array: any, compareFunc: CompareFunc): void
export function byteArraySortWithData(array: any, compareFunc: CompareDataFunc): void
export function byteArraySteal(array: any): any
...
export function datalistIdRemoveMultiple(datalist: Data, keys: Quark[]): void
...
export function dateGetWeeksInYear(year: DateYear, firstDayOfWeek: DateWeekday): number
...
export function errorDomainRegister(errorTypeName: string, errorTypePrivateSize: number, errorTypeInit: ErrorInitFunc, errorTypeCopy: ErrorCopyFunc, errorTypeClear: ErrorClearFunc): Quark
export function errorDomainRegisterStatic(errorTypeName: string, errorTypePrivateSize: number, errorTypeInit: ErrorInitFunc, errorTypeCopy: ErrorCopyFunc, errorTypeClear: ErrorClearFunc): Quark
...
export function fopen(filename: string, mode: string): object | null
...
export function freeSized(mem: object | null, size: number): void
export function freopen(filename: string, mode: string, stream?: object | null): object | null
...
export function hashTableFind(hashTable: HashTable, predicate: HRFunc): object | null
export function hashTableForeach(hashTable: HashTable, func: HFunc): void
export function hashTableForeachRemove(hashTable: HashTable, func: HRFunc): number
export function hashTableForeachSteal(hashTable: HashTable, func: HRFunc): number
...
export function hashTableRef(hashTable: HashTable): HashTable
...
export function hookInsertSorted(hookList: HookList, hook: Hook, func: HookCompareFunc): void
...
export function listPopAllocator(): void
export function listPushAllocator(allocator: Allocator): void
...
export function logGetAlwaysFatal(): LogLevelFlags
...
export function logWriterDefaultSetDebugDomains(domains?: string | null): void
...
export function logWriterSyslog(logLevel: LogLevelFlags, fields: LogField[], userData?: object | null): LogWriterOutput
...
export function memChunkInfo(): void
...
export function nodePopAllocator(): void
export function nodePushAllocator(allocator: Allocator): void
...
export function onErrorStackTrace(prgName?: string | null): void
export function onceInitEnter(location: object): boolean
export function onceInitEnterImpl(location: number): boolean
export function onceInitEnterPointer(location: object): boolean
export function onceInitLeave(location: object, result: number): void
export function onceInitLeavePointer(location: object, result?: object | null): void
...
export function pathBufEqual(v1: object, v2: object): boolean
...
export function pointerBitLockAndGet(address: object, lockBit: number): /* outPtr */ any
export function pointerBitLockMaskPtr(ptr: object | null, lockBit: number, set: boolean, preserveMask: any, preservePtr?: object | null): object | null
...
export function pointerBitUnlockAndSet(address: object, lockBit: number, ptr: object | null, preserveMask: any): void
...
export function qsortWithData(pbase: object, totalElems: number, size: number, compareFunc: CompareDataFunc): void
...
export function refCountInit(): /* rc */ number
export function refStringAcquire(str: string): string
export function refStringEqual(str1: string, str2: string): boolean
...
export function sequenceForeachRange(begin: SequenceIter, end: SequenceIter, func: Func): void
...
export function sequenceSortChanged(iter: SequenceIter, cmpFunc: CompareDataFunc): void
export function sequenceSortChangedIter(iter: SequenceIter, iterCmp: SequenceIterCompareFunc): void
...
export function setPrgnameOnce(prgname: string): boolean
...
export function slistPopAllocator(): void
export function slistPushAllocator(allocator: Allocator): void
...
export function strTokenizeAndFold(string: string, translitLocale?: string | null): [ /* returnType */ string[], /* asciiAlternates */ string[] | null ]
...
export function strdupv(strArray?: string[] | null): string[] | null
...
export function strrstrLen(haystack: string, haystackLen: number, needle: string): string | null
...
export function strstrLen(haystack: string, haystackLen: number, needle: string): string | null
...
export function testDisableCrashReporting(): void
...
export function testTrapSubprocessWithEnvp(testPath: string | null, envp: string[] | null, usecTimeout: number, testFlags: TestSubprocessFlags): void
...
export function ucs4ToUtf16(str: string): [ /* returnType */ number, /* itemsRead */ number | null, /* itemsWritten */ number | null ]
export function ucs4ToUtf8(str: string): [ /* returnType */ string, /* itemsRead */ number | null, /* itemsWritten */ number | null ]
...
export function unicharGetMirrorChar(ch: number): [ /* returnType */ boolean, /* mirroredCh */ number ]
...
export function utf16ToUcs4(str: number[]): [ /* returnType */ number, /* itemsRead */ number | null, /* itemsWritten */ number | null ]
export function utf16ToUtf8(str: number[]): [ /* returnType */ string, /* itemsRead */ number | null, /* itemsWritten */ number | null ]
...
export function utf8TruncateMiddle(string: string, truncateLength: number): string
export function utf8Validate(str: any): [ /* returnType */ boolean, /* end */ any | null ]
export function utf8ValidateLen(str: any): [ /* returnType */ boolean, /* end */ any | null ]
export function utime(filename: string, utb?: object | null): number
...
export function variantTypeChecked(typeString: string): VariantType
...
export interface CacheDestroyFunc {
    (value?: object | null): void
}
export interface CacheDupFunc {
    (value?: object | null): object | null
}
export interface CacheNewFunc {
    (key?: object | null): object | null
}
...
export interface CompletionStrncmpFunc {
...
export interface LogFunc {
    (logDomain: string | null, logLevel: LogLevelFlags, message: string): void
}
...
export interface SourceFuncsCheckFunc {
    (source: Source): boolean
}
export interface SourceFuncsFinalizeFunc {
    (source: Source): void
}
export interface SourceFuncsPrepareFunc {
    (source: Source): boolean
}
...
export class AsyncQueue {
    ...
    pushFront(item: object): void
    pushFrontUnlocked(item: object): void
    pushSorted(data: object, func: CompareDataFunc): void
    pushSortedUnlocked(data: object, func: CompareDataFunc): void
    pushUnlocked(data: object): void
    ref(): AsyncQueue
    refUnlocked(): void
    remove(item: object): boolean
    removeUnlocked(item: object): boolean
    ...
    unrefAndUnlock(): void
    static name: string
    static newFull(itemFreeFunc?: DestroyNotify | null): AsyncQueue
}
export class BookmarkFile {
    ...
    getAppInfo(uri: string, name: string): [ /* returnType */ boolean, /* exec */ string | null, /* count */ number | null, /* stamp */ any ]
    ...
    setAppInfo(uri: string, name: string, exec: string, count: number, stamp: any): boolean
...
export class ByteArray {
    ...
    len: number
    static name: string
    static append(array: any, data: any): any
    static free(array: any, freeSegment: boolean): any | null
    static freeToBytes(array: any): Bytes
    static newTake(data: any): any
    static prepend(array: any, data: any): any
    static ref(array: any): any
    static removeIndex(array: any, index: number): any
    static removeIndexFast(array: any, index: number): any
    static removeRange(array: any, index: number, length: number): any
    static setSize(array: any, length: number): any
    static sizedNew(reservedSize: number): any
    static sort(array: any, compareFunc: CompareFunc): void
    static sortWithData(array: any, compareFunc: CompareDataFunc): void
    static steal(array: any): any
...
export class Cache {
    /* Methods of GLib.Cache */
    destroy(): void
    insert(key?: object | null): object | null
    keyForeach(func: HFunc): void
    remove(value?: object | null): void
...
export class Checksum {
    ...
    static name: string
    static new(checksumType: ChecksumType): Checksum | null
    constructor(checksumType: ChecksumType)
    static new(checksumType: ChecksumType): Checksum | null
    static typeGetLength(checksumType: ChecksumType): number
}
export class Completion {
    /* Fields of GLib.Completion */
    items: object[]
    func: CompletionFunc
    prefix: string
    cache: object[]
    strncmpFunc: CompletionStrncmpFunc
    /* Methods of GLib.Completion */
    clearItems(): void
    completeUtf8(prefix: string, newPrefix: string): string[]
    free(): void
    static name: string
}
export class Cond {
...
export class Date {
    ...
    getWeekOfYear(firstDayOfWeek: DateWeekday): number
    ...
    static getWeeksInYear(year: DateYear, firstDayOfWeek: DateWeekday): number
...
export class DateTime {
    ...
    static new(tz: TimeZone, year: number, month: number, day: number, hour: number, minute: number, seconds: number): DateTime | null
    static newFromIso8601(text: string, defaultTz?: TimeZone | null): DateTime | null
    static newFromTimevalLocal(tv: TimeVal): DateTime | null
    static newFromTimevalUtc(tv: TimeVal): DateTime | null
    static newFromUnixLocal(t: number): DateTime | null
    static newFromUnixLocalUsec(usecs: number): DateTime | null
    static newFromUnixUtc(t: number): DateTime | null
    static newFromUnixUtcUsec(usecs: number): DateTime | null
    static newLocal(year: number, month: number, day: number, hour: number, minute: number, seconds: number): DateTime | null
    static newNow(tz: TimeZone): DateTime | null
    static newNowLocal(): DateTime | null
    static newNowUtc(): DateTime | null
    static newUtc(year: number, month: number, day: number, hour: number, minute: number, seconds: number): DateTime | null
}
...
export class Error {
    ...
    static domainRegister(errorTypeName: string, errorTypePrivateSize: number, errorTypeInit: ErrorInitFunc, errorTypeCopy: ErrorCopyFunc, errorTypeClear: ErrorClearFunc): Quark
    static domainRegisterStatic(errorTypeName: string, errorTypePrivateSize: number, errorTypeInit: ErrorInitFunc, errorTypeCopy: ErrorCopyFunc, errorTypeClear: ErrorClearFunc): Quark
}
export class HashTable {
    ...
    static find(hashTable: HashTable, predicate: HRFunc): object | null
...
export class Hmac {
    ...
    static name: string
    static new(digestType: ChecksumType, key: number, keyLen: number): Hmac
    constructor(digestType: ChecksumType, key: number, keyLen: number)
    static new(digestType: ChecksumType, key: number, keyLen: number): Hmac
}
export class Hook {
    /* Fields of GLib.Hook */
    ...
    static insertSorted(hookList: HookList, hook: Hook, func: HookCompareFunc): void
...
export class IOChannel {
    ...
    getEncoding(): string
    getFlags(): IOFlags
    getLineTerm(): [ /* returnType */ string, /* length */ number | null ]
    init(): void
...
export class MainContext {
    ...
    dispatch(): void
    findSourceByFuncsUserData(funcs: SourceFuncs, userData?: object | null): Source | null
    findSourceById(sourceId: number): Source
    findSourceByUserData(userData?: object | null): Source | null
...
export class MemChunk {
    /* Methods of GLib.MemChunk */
    alloc(): object | null
    alloc0(): object | null
    clean(): void
    destroy(): void
    free(mem?: object | null): void
    print(): void
    reset(): void
    static name: string
    static info(): void
...
export class Node {
    ...
    traverse(order: TraverseType, flags: TraverseFlags, maxDepth: number, func: NodeTraverseFunc): void
    unlink(): void
    static name: string
    static popAllocator(): void
    static pushAllocator(allocator: Allocator): void
...
export class Once {
    ...
    static initEnterPointer(location: object): boolean
    static initLeave(location: object, result: number): void
    static initLeavePointer(location: object, result?: object | null): void
}
...
export class PathBuf {
    /* Fields of GLib.PathBuf */
    /* Methods of GLib.PathBuf */
    clear(): void
    ...
    toPath(): string | null
    static name: string
    static equal(v1: object, v2: object): boolean
}
...
export class Queue {
    ...
    init(): void
    insertSorted(data: object | null, func: CompareDataFunc): void
    isEmpty(): boolean
...
export class Regex {
    ...
    unref(): void
    static name: string
    static new(pattern: string, compileOptions: RegexCompileFlags, matchOptions: RegexMatchFlags): Regex | null
    ...
    static escapeString(string: string, length: number): string
...
export class Relation {
    /* Methods of GLib.Relation */
    count(key: object | null, field: number): number
    delete(key: object | null, field: number): number
    destroy(): void
    print(): void
    static name: string
}
...
export class Sequence {
    ...
    getLength(): number
    insertSorted(data: object | null, cmpFunc: CompareDataFunc): SequenceIter
    insertSortedIter(data: object | null, iterCmp: SequenceIterCompareFunc): SequenceIter
    isEmpty(): boolean
    lookup(data: object | null, cmpFunc: CompareDataFunc): SequenceIter | null
    lookupIter(data: object | null, iterCmp: SequenceIterCompareFunc): SequenceIter | null
    prepend(data?: object | null): SequenceIter
    search(data: object | null, cmpFunc: CompareDataFunc): SequenceIter
    searchIter(data: object | null, iterCmp: SequenceIterCompareFunc): SequenceIter
    sort(cmpFunc: CompareDataFunc): void
    sortIter(cmpFunc: SequenceIterCompareFunc): void
    static name: string
    static foreachRange(begin: SequenceIter, end: SequenceIter, func: Func): void
    ...
    static sortChangedIter(iter: SequenceIter, iterCmp: SequenceIterCompareFunc): void
...
export class StaticMutex {
    /* Fields of GLib.StaticMutex */
    mutex: Mutex
    /* Methods of GLib.StaticMutex */
    getMutexImpl(): Mutex
    static name: string
}
export class StaticPrivate {
    /* Fields of GLib.StaticPrivate */
    /* Methods of GLib.StaticPrivate */
    static name: string
}
export class StaticRWLock {
    /* Fields of GLib.StaticRWLock */
    /* Methods of GLib.StaticRWLock */
    static name: string
}
export class StaticRecMutex {
    /* Fields of GLib.StaticRecMutex */
    /* Methods of GLib.StaticRecMutex */
    static name: string
}
export class String {
...
export class ThreadFunctions {
    /* Fields of GLib.ThreadFunctions */
    mutexNew: any
    mutexLock: any
    mutexTrylock: any
    mutexUnlock: any
...
export class TimeZone {
    ...
    static new(identifier?: string | null): TimeZone
    static newIdentifier(identifier?: string | null): TimeZone | null
...
export class Tree {
    ...
    insertNode(key?: object | null, value?: object | null): TreeNode | null
    ...
    replaceNode(key?: object | null, value?: object | null): TreeNode | null
    search(searchFunc: CompareFunc): object | null
...
export class Tuples {
    /* Fields of GLib.Tuples */
    len: number
    /* Methods of GLib.Tuples */
    destroy(): void
    index(index: number, field: number): object | null
    static name: string
}
export class UnixPipe {
    /* Fields of GLib.UnixPipe */
    fds: number[]
    static name: string
}
export class Uri {
