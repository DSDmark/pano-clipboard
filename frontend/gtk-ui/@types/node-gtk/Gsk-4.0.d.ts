...
export function componentTransferEqual(self: object, other: object): boolean
export function pathParse(string: string): Path | null
export function serializationErrorQuark(): GLib.Quark
export function strokeEqual(stroke1?: object | null, stroke2?: object | null): boolean
...
export class BlendNode {
    ...
    getOpaqueRect(): [ /* returnType */ boolean, /* outOpaque */ Graphene.Rect ]
    ref(): RenderNode
    serialize(): any
    unref(): void
...
export class ComponentTransferNode {
    ...
    getChild(): RenderNode
    getTransfer(component: number): ComponentTransfer
    /* Methods of Gsk.RenderNode */
    draw(cr: cairo.Context): void
    getBounds(): /* bounds */ Graphene.Rect
    getNodeType(): RenderNodeType
...
export class RenderNode {
    ...
    writeToFile(filename: string): boolean
    static name: string
    static deserialize(bytes: any, errorFunc?: ParseErrorFunc | null): RenderNode | null
}
...
export class Renderer {
    ...
    static newForSurface(surface: Gdk.Surface): Renderer | null
    static $gtype: GObject.Type
}
...
export class ComponentTransfer {
    ...
    free(): void
    static name: string
    static newDiscrete(values: number[]): ComponentTransfer
    static newGamma(amp: number, exp: number, ofs: number): ComponentTransfer
    static newIdentity(): ComponentTransfer
    static newLevels(n: number): ComponentTransfer
    static newLinear(m: number, b: number): ComponentTransfer
    static newTable(values: number[]): ComponentTransfer
...
export class Path {
    ...
    foreachIntersection(path2: Path | null, func: PathIntersectionFunc): boolean
    getBounds(): [ /* returnType */ boolean, /* bounds */ Graphene.Rect ]
    getClosestPoint(point: Graphene.Point, threshold: number): [ /* returnType */ boolean, /* result */ PathPoint, /* distance */ number | null ]
    getEndPoint(): [ /* returnType */ boolean, /* result */ PathPoint ]
    getStartPoint(): [ /* returnType */ boolean, /* result */ PathPoint ]
    getStrokeBounds(stroke: Stroke): [ /* returnType */ boolean, /* bounds */ Graphene.Rect ]
...
export class PathBuilder {
    ...
    htmlArcTo(x1: number, y1: number, x2: number, y2: number, radius: number): void
    lineTo(x: number, y: number): void
    moveTo(x: number, y: number): void
    quadTo(x1: number, y1: number, x2: number, y2: number): void
    ref(): PathBuilder
    relArcTo(x1: number, y1: number, x2: number, y2: number): void
    relConicTo(x1: number, y1: number, x2: number, y2: number, weight: number): void
    relCubicTo(x1: number, y1: number, x2: number, y2: number, x3: number, y3: number): void
    relHtmlArcTo(x1: number, y1: number, x2: number, y2: number, radius: number): void
    relLineTo(x: number, y: number): void
    relMoveTo(x: number, y: number): void
    relQuadTo(x1: number, y1: number, x2: number, y2: number): void
    relSvgArcTo(rx: number, ry: number, xAxisRotation: number, largeArc: boolean, positiveSweep: boolean, x: number, y: number): void
    svgArcTo(rx: number, ry: number, xAxisRotation: number, largeArc: boolean, positiveSweep: boolean, x: number, y: number): void
    toPath(): Path
    unref(): void
    static name: string
...
export class PathMeasure {
    ...
    getLength(): number
    getPath(): Path
    getPoint(distance: number): [ /* returnType */ boolean, /* result */ PathPoint ]
    getTolerance(): number
    ref(): PathMeasure
    unref(): void
    static name: string
...
export class PathPoint {
    ...
    free(): void
    getCurvature(path: Path, direction: PathDirection): [ /* returnType */ number, /* center */ Graphene.Point | null ]
    ...
    getTangent(path: Path, direction: PathDirection): /* tangent */ Graphene.Vec2
    static name: string
}
...
export class Transform {
    ...
    matrix2d(xx: number, yx: number, xy: number, yy: number, dx: number, dy: number): Transform | null
