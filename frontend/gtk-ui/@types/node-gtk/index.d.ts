/* eslint-disable @typescript-eslint/triple-slash-reference */
        /// <reference path="Adw-1.d.ts" />
            ...
            /// <reference path="GIRepository-3.0.d.ts" />
            /// <reference path="GL-1.0.d.ts" />
            /// <reference path="GLib-2.0.d.ts" />
            /// <reference path="GLibUnix-2.0.d.ts" />
            /// <reference path="GModule-2.0.d.ts" />
            /// <reference path="GObject-2.0.d.ts" />
            /// <reference path="Gdk-4.0.d.ts" />
            /// <reference path="GdkPixbuf-2.0.d.ts" />
            /// <reference path="GdkPixdata-2.0.d.ts" />
            /// <reference path="GdkWayland-4.0.d.ts" />
            /// <reference path="GdkX11-4.0.d.ts" />
...
declare module 'node-gtk' {
    export function require(ns: string, ver?: string): any;
            export function require(ns: 'Adw'): typeof Adw;
        export function require(ns: 'Adw', ver?: '1'): typeof Adw;
            export function require(ns: 'AppStream'): typeof AppStream;
        export function require(ns: 'AppStream', ver?: '1.0'): typeof AppStream;
        ...
        export function require(ns: 'GIRepository', ver?: '3.0'): typeof GIRepository;
        ...
        export function require(ns: 'GLib', ver?: '2.0'): typeof GLib;
            export function require(ns: 'GLibUnix'): typeof GLibUnix;
        export function require(ns: 'GLibUnix', ver?: '2.0'): typeof GLibUnix;
        ...
        export function require(ns: 'GdkPixdata', ver?: '2.0'): typeof GdkPixdata;
            export function require(ns: 'GdkWayland'): typeof GdkWayland;
        export function require(ns: 'GdkWayland', ver?: '4.0'): typeof GdkWayland;
            export function require(ns: 'GdkX11'): typeof GdkX11;
        export function require(ns: 'GdkX11', ver?: '4.0'): typeof GdkX11;
            export function require(ns: 'Gio'): typeof Gio;
        export function require(ns: 'Gio', ver?: '2.0'): typeof Gio;
            export function require(ns: 'GioUnix'): typeof GioUnix;
        export function require(ns: 'GioUnix', ver?: '2.0'): typeof GioUnix;
            export function require(ns: 'Gly'): typeof Gly;
        export function require(ns: 'Gly', ver?: '2'): typeof Gly;
